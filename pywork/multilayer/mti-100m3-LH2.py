...
class Multilayer(object):
    def __init__(self, num, temp0, tempn):
        self.tlayer0 = temp0           # 外壳温度
        self.tlayer1 = self.tlayer0 - 0.01
        self.tlayern = tempn            # 内壁温度
        self.qrad = []               # 辐射传热
        self.qsld = []               # 固体传热
        self.qgas = []               # 气体传热
        self.qtot = []               # 总传热
...
for i in range(35):
    t0 = 33 + 10 * i
    tn = 20
    ml80 = Multilayer(80, t0, tn)
    print '内外温度为：' + str(tn) + ', ' + str(t0)
    print '绝热层数为 80 层时，热流密度为：' + str(ml80.q0)
